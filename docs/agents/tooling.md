...
Everything on this page is optional. None of it is needed to build, test, or contribute to Threadbase CI Dashboard — it is the AI-assistant tooling this repo expects, declared in config so your agent can pick it up instead of you wiring it by hand.
...
|---|---|---|
| `neon` | `claude-plugins-official` | Neon Postgres branching, queries, and migrations |
...
codex plugin add neon@claude-plugins-official
