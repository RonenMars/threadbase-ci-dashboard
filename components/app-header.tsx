  ...
  return (
    <>
      <header className="sticky top-0 z-50 overflow-x-clip border-b border-border bg-(--tb-ink-4)/80 backdrop-blur">
        <div className="mx-auto flex h-14 w-full min-w-0 max-w-6xl items-center gap-3 px-4 max-sm:ps-18 sm:gap-4 sm:px-6">
      ...
      {/* Floating hamburger lives outside the blurred header so position:fixed
          is viewport-relative — same pattern as tb-landing NavMenu. */}
