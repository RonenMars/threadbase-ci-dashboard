...
/** Port of tb-landing `components/NavMenu` — floating hamburger on desktop and mobile. */
export function NavMenu({ role, name, image }: NavMenuProps): React.JSX.Element {
                ...
                <div className="flex items-center justify-between gap-3">
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <p className="truncate text-xs font-semibold text-muted">Threadbase CI</p>
...
/** @deprecated Use NavMenu — kept as an alias while imports migrate. */
export const MobileNav = NavMenu
